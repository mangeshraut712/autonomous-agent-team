...
```bash
openclaw cron run 64334029-8651-445c-98e8-dd7c45042a28 --force  # Dwight Morning
openclaw cron run b30ef0eb-fbcd-41a3-b7b5-22855ea33fe5 --force  # Kelly Viral
openclaw cron run 8cee5580-04c2-4a93-b620-4bc332b0b279 --force  # Ross Engineering
```
